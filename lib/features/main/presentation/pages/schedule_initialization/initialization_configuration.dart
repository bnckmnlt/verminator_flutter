...
class InitializationConfiguration extends StatefulWidget {
  ...
  @override
  State<InitializationConfiguration> createState() =>
      _InitializationConfigurationState();
}

class _InitializationConfigurationState
    extends State<InitializationConfiguration> {
